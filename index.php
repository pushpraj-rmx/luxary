...
<head>
    ...
    <title>Namo Green Farms | Maraj Realty | Best Farm House in Delhi</title>
...
<body>
                    ...
                    <div class="header_container d-flex align-items-center">
                        ...
                        <div class="header_right_info header_right7">
                            ...
                            <div class="add_property">
                                <a class="openButton">Book a Tour</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single_slider_inner">
                                <div class="slider_text slider_text7 " style="text-align:center">
                                    <!-- <h3>Luxury Home</h3> -->
                                    <h1>Govt Approved Farms and Farmhouses for Sale</h1>
                                    <p>
                                        Buy Farmhouses and Farmland very close to Delhi, Near Jewar International Airport
                                    </p>
                                    <div class="add_property">
                                        <a href="#" class="sqr-btn">Book <span style="text-transform: lowercase; text-align:center">a</span> Tour</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="single_slider_inner">
                                <div class="slider_text slider_text7">
                                    <!-- <h3>Luxury Home</h3> -->
                                    <h1>Luxury Farmhouses & Farm Plots Near Delhi</h1>
                                    <p>
                                        Govt Approved Farmhouses and Farmplots Opposite to Jewar
                                        International Airport
                                    </p>
                                    <!-- <h2><span>Price: $256874</span></h2> -->
                                    <a href="#" class="sqr-btn">Read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- <button class="openButton">Open Popup 1</button> -->
    <!-- <button class="openButton">Open Popup 2</button> -->
    <button class="openButton sticky-side-popup">Open Popup</button>

    <div class="overlay" id="overlay"></div>
    <div class="popup" id="popup">
        <div class="contact-form">
            <h2 style="color: black; font-size: 1.3rem; font-weight: 900; text-align: center; text-decoration: underline;">
                Pop-up Form
            </h2>
                            ...
                            <div class="choose_section_thumb">
                                ...
                                <a href="">
                                    <div class="choose_position_text">
                                        ...
                                        <p>
                                            Investment for greater returns,<br>upgraded lifestyle & sustainable living.
                                        </p>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-7">
                        <div class="choose_us_sidebar wow fadeInRight" data-wow-delay="0.2s" data-wow-duration="1.5s">
                            <div class="section_titile">
                                <h2>4 Reasons to Buy a Farm</h2>
                                <p>
                                    NAMO Green Farms is located at the most prime location near Delhi.
                                    Several development projects are ongoing which makes it perfect for investing.
                            ...
                            <div class="choose_us_gallery">
                                <div class="choose_list mb-50">
                                    ...
                                    <div class="choose_text">
                                        ...
                                        <p>
                                            It is located near to Jewar International Airport (3 km or 10 min distance from the airport)
                                        </p>
                                    </div>
                                </div>
                                <div class="choose_list mb-50">
                                    ...
                                    <div class="choose_text">
                                        ...
                                        <p>
                                            Rapid infrastructure development like metro connectivity, pod taxi, industrial parts and logistic hubs.
                                        </p>
                                    </div>
                                </div>
                                <div class="choose_list">
                                    ...
                                    <div class="choose_text">
                                        ...
                                        <p>
                                            Walking distance from Noida international airport.
                                        </p>
                                    </div>
                                </div>
                                <div class="choose_list">
                                    ...
                                    <div class="choose_text">
                                        <h3>Right time for investment</h3>
                                        <p>
                                            Several development projects are ongoing which makes it perfect for investing.
                                        </p>
                                    </div>
                                </div>
                                <a href="" class="sqr-btn" style="margin: 40px 0px 0px 30px; color:white; ">Download Brouchere</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container" style="margin-bottom: 50px;">
            <h3 class="heading-box">Location Advantage</h3>
                ...
                <div class="main-group">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <li style="list-style: georgian;">
                                <b>
                                    Noida International Airport (3 km)
                                </b>
                            </li>
                            <br>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <li>
                                ISBT, Metro Station, Pod Taxi &
                            </li>
                            <li style="list-style: georgian;">
                                <b>
                                    All Other Conveyance with In 2-3 km
                                </b>
                            </li>
                        </div>
                    </div>
        ...
        <div class="container" style="margin-bottom: 100px;">
            <h3 class="heading-box">Project USP's</h3>
            <div class="location-advantage">
                <div class="main-group">
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            ...
                            <li>
                                <b>
                                    Government Electricity, Haryana Registry & Mutation
                                </b>
                            </li> <br>
                            <li>
                                <b>
                                    High-End Gated Society
                                </b>
                            </li> <br>
                            <li>
                                <b>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section_titile">
                        <h2>Our USP's</h2>
                        <p>
                            Perfect blend of modern comfort and rustic charm.
                            These properties will redefine country living .
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="exchange_p_container d-flex justify-content-between">
                        <div class="exchange_p_list wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                            <div class="exchange_p_icon" style="text-align: center;">
                                <img src="assets/img/icon/easy_way-02.png" alt="">
                            </div>
                            <div class="exchange_p_text" style="text-align: center;">
                                <h3>RCC Construction Approved</h3>
                                <p>
                                    Best Investment Opportunity Near Jewar Airport.
                                </p>
                            </div>
                        </div>
                        <div class="exchange_p_list wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1.2s">
                            ...
                            <div class="exchange_p_text" style="text-align: center;">
                                <h3>पक्की रजिस्ट्री</h3>
                                <p>
                                    Get Immediate Registration of your Property
                                </p>
                            </div>
                        </div>
                        <div class="exchange_p_list wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            ...
                            <div class="exchange_p_text" style="text-align: center;">
                                <h3>Immediate Registration <br> and Mutation</h3>
                                <p>
                                    Ensuring seamless, Registration
                                </p>
                            </div>
                        </div>
                        <div class="exchange_p_list wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            <div class="exchange_p_icon" style="text-align: center;">
                                <img src="assets/img/icon/govt-approved.png" alt="">
                            </div>
                            <div class="exchange_p_text" style="text-align: center;">
                                <h3>Government Approved Farms</h3>
                                <p>
                                    NOC by Haryana and Punjab Town Planners
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container mb-5 pb-5">
        <div class="row">
            <div class="col-12">
                <div class="image">
                    <img src="./assets/img/current-location-min.jpg" alt="">
                </div>
            </div>
        </div>
        <!--luxurious_ nterior area start-->
        <div class="luxurious_interior_area mb-132" style="margin-top: 100px;" 1>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                                ...
                                "responsive":[  
                                  {"breakpoint":576, "settings": { "slidesToShow": 1 } }  
                                    ...
                                    <div class="luxurious_thumb">
                                        <a href="#"><img src="assets/img/newspapers/9.jpg" alt=""></a>
                                    </div>
                                    <div class="luxurious_thumb">
                                        <a href="#"><img src="assets/img/newspapers/01.jpg" alt=""></a>
                                    </div>
                                    <div class="luxurious_thumb">
                                        <a href="#"><img src="assets/img/newspapers/7.jpg" alt=""></a>
                                    </div>
                                    <div class="luxurious_thumb">
                                        <a href="#"><img src="assets/img/newspapers/6.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="luxurious_button">
                                    <a href="#"> From newspapers</a>
                                </div>
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="amenities_banner">
                            <div class="amenities_thumb one wow fadeInLeft" data-wow-delay="0.4s" data-wow-duration="1s">
                                <img src="assets/img/map-min.jpg" alt="">
                            </div>
                        ...
                        <div class="amenities_sidebar wow fadeInRight" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            ...
                            <div class="amenities_container">
                                <div class="amenities_checkbox_list">
                                    <p><i class="icofont-checked"></i> <span>Proposed Noida International Airport</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed POD Taxi Station</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed ISBT, Jewar</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed Metro Station</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed Film City</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed YEIDA Industrial & Residential Sector</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed 130 MTR YEIDA Sectors Road Just 800 MTR</span></p>
                                    <p><i class="icofont-checked"></i> <span>Proposed 110 MTR. DMIC Road</span></p>
                                </div>
                                <!-- <div class="amenities_checkbox_list">
                        ...
                        <div class="floor_plan_demo d-flex justify-content-between">
                            <div class="floor_single_demo wow fadeInRight" data-wow-delay="0.1s" data-wow-duration="1.1s">
                                <div class="floor_demo_thumb">
                                    <img src="assets/img/master-plan.webp" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                "infinite": true                                                        
                                    ...
                                    <div class="single_testimonial">
                                        <div class="testimonial_content">
                                            ...
                                            <div class="testimonial_desc">
                                                <p>
                                                    "Pleasure rationally encounter way to find painful have some of the
                                                    very easily from wide range of so can buy creative more than a great
                                                    or sale your dream and your dream happy property"
                                                </p>
                                            </div>
                                            <div class="testimonial_thumb_author">
                                                <div class="author_img">
...
============================================ -->
        ...
        <script>
            ...
            const oepnPopup = function() {
                overlay.style.display = 'block';
                popup.style.display = 'block';
            }
            openButtons.forEach(function(button) {
                button.addEventListener('click', oepnPopup);
            });
